...
export default function thisWebsite() {
  ...
  if (website != null) {
    ...
    let sentences = [
      ...
      `One of my initial sources of inspiration (or the original creation that I blatantly and unashamedly copied as others might erroneously say) was the beautiful and award-winning website of <a href="https://souldesign.gr/" target="_blank">SOUL Design</a>. ॐ`,
    ];
