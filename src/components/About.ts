...
export default function about() {
  ...
  if (about != null) {
    ...
    let sentences = [
      ...
      "I love working with React, Redux, Tailwind CSS, as well as, Styled Components.",
      ...
      "I've been  to many countries meeting and getting to know people from all over the world.",
