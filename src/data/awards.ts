...
export const awardList = [
  ...
  },
  {
    ...
    description: `Another award for my portofolio website, awarded by Best CSS, a web platform that discovers, recognizes and promotes the talent and effort of web designers, developers and agencies who create unique digital experiences that are useful, innovative, intuitive and beautiful.`,
  },
];
